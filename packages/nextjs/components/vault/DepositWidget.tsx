...
const DepositWidget = () => {
  ...
  return (
    <div>
      <div className="flex bg-secondary rounded-2xl items-left flex-col flex-grow pt-4 mb-4">
        <div className="mb-2 flex flex-row justify-between mx-12">
          <div>
            <h1>Your Balance</h1>
            <div className="flex flex-row">
              <div className="pb-1 inline-flex items-center justify-center">
                {parseFloat(formatEther(yourBTTDCBalance || "0")).toFixed(0)} <h1 className="pl-2 pt-2">TTDC</h1>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-row">
              <div className="pb-1 inline-flex items-center justify-center">
                {parseFloat(formatEther(yourVTTDCBalance || "0")).toFixed(0)} <h1 className="pl-2 pt-2">TTDC</h1>
              </div>
            </div>
